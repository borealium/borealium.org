sma-nds = NDS for South Sámi
sma-nds-description = Dictionary resources for South Sámi
sma-nds-more-info = NDS — Nedtedigibaakoe — for South Sámi contains dictionaries translating to and from South Sámi.
sma-nds-links-0 = NDS Åarjel
