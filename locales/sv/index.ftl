...
maintaining-this-website = Underhåll av denna webbplats
resource = Resurs
category = Kategori
language = Språk
back-to-top = Tillbaka till toppen
read-more = Läs mer
see-more-results = Se fler sökresultat
no-resources-in-category = Inga resurser hittades i denna kategori.
news = Nyheter
...
for-macos = på macOS
for-ios-and-android = på iOS och Android
dm-button-title = Divvun Manager
dm-button-description = på Windows och macOS
...
more-info-spellers =
    ...
    Det finns andra rättstavningsverktyg också, både kommersiella och öppna.
    
    På Windows fungerar GiellaLT-rättstavningsverktygen i MS Office, LibreOffice och flera andra program. I macOS fungerar verktygen i de flesta programmen.
    
    För att använda GiellaLT-rättstavning i **LibreOffice för macOS**, måste du manuellt installera¶
    ett [separat LibreOffice-tillägg](/resource/divvunspell-libreoffice/).¶
    ¶
...
more-info-keyboards =
    ...
    Divvun Manager. Tangentbord för ChromeOS måste läggas in i vår ChromeOS-app manuelt.
    
    Många språk har också tangentbord för Android och iOS. Dessa blir distribuerade via våra
    tangentbordsappar.
macos = macOS
windows = Windows
mobile = Mobil
github = GitHub
linux = Linux
error-404-title = 404 - Hittades inte
error-404-message = Sidan hittades inte
error-404-suggestion = Sidan du letar efter finns inte eller har flyttats.
error-500-message = Internt serverfel
error-title = Fel
error-go-home = Gå till startsidan
