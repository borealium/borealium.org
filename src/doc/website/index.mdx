...
**NB!** Make sure the id string does not contain anything but ASCII letters and hyphen. No
underscores, no nothing beyond ASCII letters and hyphen.
...
This plugin implements the Fluent wrappers so that `.flt` files can be used with this website.
